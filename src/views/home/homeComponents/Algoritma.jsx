        ...
        <div className='lg:-mt-20'>
            <div className="hero min-h-screen">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <div className='mt-20'>
                        <img src="https://storage.googleapis.com/image_chillitify/web-asset/den.png" className="max-w-xs lg:max-w-sm rounded-lg shadow-2xl" />
                    </div>
                    <div>
                        ...
                        <p className="pb-6 text-justify">
                            Confidence dalam prediksi penyakit menggunakan CNN adalah tingkat keyakinan model terhadap hasil prediksinya. Model memberikan probabilitas untuk setiap penyakit, menunjukkan seberapa yakin model bahwa prediksi tersebut benar. Confidence 1 berarti model sangat yakin dengan prediksinya, sementara confidence rendah menunjukkan ketidakpastian.
                        </p>
                    </div>
                </div>
            </div>
